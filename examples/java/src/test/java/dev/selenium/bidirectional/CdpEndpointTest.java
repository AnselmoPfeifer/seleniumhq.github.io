...
public class CdpEndpointTest extends BaseTest {
  ...
  public void setCookie() {
    ...
    cdpExecutor.executeCdpCommand("Network.setCookie", cookie);
  ...
  public void performanceMetrics() {
    ...
    HasCdp cdpExecutor = (HasCdp) driver;
    cdpExecutor.executeCdpCommand("Performance.enable", new HashMap<>());

    Map<String, Object> response =
        cdpExecutor.executeCdpCommand("Performance.getMetrics", new HashMap<>());
  ...
  public void basicAuth() {
    HasCdp cdpExecutor = (HasCdp) driver;
    cdpExecutor.executeCdpCommand("Network.enable", new HashMap<>());
    ...
    cdpExecutor.executeCdpCommand("Network.setExtraHTTPHeaders", headers);
